...
updateUserStatus(userId: string, unlocked: boolean) {
  const requestBody = { unlocked }; // Créez un objet contenant le statut

  return this.http.post<any>(`${this.url}/${userId}/status`, requestBody);
}
